...
int main(int argc, const char *argv[]) {
  ...
  // cout << "------------Program------------" << endl;
  // cout << raw.values.len  << " " << raw.funcs.len<< endl;
  // cout << raw.values.kind << endl;
  // cout << raw.funcs.kind << endl;
  // for(int i = 0; i < raw.values.len; i++) {
  //   cout << raw.values.buffer[i] << endl;
  // }
  // for(int i = 0; i < raw.funcs.len; i++) {
  //   cout << raw.funcs.buffer[i] << endl;
  // }
